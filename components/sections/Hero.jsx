  ...
  return (
    <section className="relative px-6 pb-9 pt-28 md:px-[72px] md:pt-28">
      <div className="mx-auto flex max-w-shell flex-col gap-5 lg:flex-row">
        {/* ---- type panel ---- */}
        <div className="relative flex-shrink-0 overflow-hidden rounded-panel border border-bone/[0.07] bg-gradient-to-b from-panel to-ink2 lg:h-[664px] lg:w-[620px]">
          ...
          <div className="relative flex h-full flex-col p-8 md:p-11 lg:pl-[72px]">
            <div className="mb-8 font-mono text-[10px] tracking-label text-dim">PORTFOLIO — 2026</div>

            <h1 className="text-[clamp(3.4rem,11vw,7.125rem)] font-bold leading-[0.84] tracking-[-0.035em]">
              RAJA
            </h1>
            <h1 className="text-[clamp(3.4rem,11vw,7.125rem)] font-extralight leading-[0.84] tracking-[-0.025em] text-bone/[0.58]">
              KANNAN
            </h1>

            <p className="mt-8 max-w-[440px] text-base font-light leading-relaxed text-bone/60">
            ...
            <div className="flex items-end justify-between gap-6">
              <p className="hidden max-w-[200px] text-[13px] font-light leading-relaxed text-mute sm:block">
              ...
              <Link
                ...
                data-cursor="play"
                className="group relative h-[140px] w-full overflow-hidden rounded-2xl sm:w-[268px]"
              >
        ...
        <div className="relative flex-grow overflow-hidden rounded-panel border border-bone/[0.07] bg-[radial-gradient(120%_100%_at_55%_30%,#241C56_0%,#140F30_42%,#0A0912_100%)]">
          <div className="relative h-[400px] sm:h-[500px] lg:h-[664px]" data-cursor="drag">
            <HeroCanvas variant={variant} />
          </div>

          <div className="pointer-events-none absolute bottom-24 left-1/2 h-10 w-[380px] max-w-[70%] -translate-x-1/2 rounded-[50%] bg-violet/50 blur-[24px]" />

          {/* spec HUD */}
          <div className="absolute right-5 top-5 w-[242px] rounded-2xl border border-bone/10 bg-ink/70 p-5 pb-3.5 backdrop-blur-sm">
          ...
          {/* notched corner */}
          <div className="absolute bottom-0 left-0 flex h-[76px] w-[196px] items-center gap-3 rounded-tr-[20px] bg-ink pl-6">
      ...
      <div className="mx-auto mt-7 flex max-w-shell flex-wrap items-center gap-4 px-1">
        {['MOTION DESIGNER', '3D ARTIST', 'AI VISUAL CREATOR', 'PHOTOGRAPHER'].map((r, i) => (
          <span key={r} className="flex items-center gap-4">
            ...
            <span className="font-mono text-[11px] tracking-[0.2em] text-dim">{r}</span>
          </span>
        ))}
        <span className="ml-auto hidden font-mono text-[11px] tracking-[0.2em] text-dim md:inline">
